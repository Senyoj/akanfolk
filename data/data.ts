...
export const gamedata = [
  ...
  export const games = [
    {
      title: "Anhwɛwoakyire",
      description: "A moonlight circle game where players squat in a circle while one player runs around with a folded cloth. The name literally means 'do not look back'. Players must be alert to feel when the cloth is placed behind them, as looking back is against the rules.",
      mainImage: "/anhwewoakyire-main.png",
      images: [
        "/anhwewoakyire-1.png",
        "/anhwewoakyire-2.png",
        "/anhwewoakyire-3.png"
      ...
      setting: "Moonlight",
      ageGroup: "All ages",
      materials: ["Folded cloth"],
      type: "Circle game",
      tags: ["moonlight game", "circle game", "singing game"]
    },
    {
      title: "Aso (Teele)",
      description: "A dynamic jumping game where players take turns being thrown into the air by their friends. The name 'Teele' literally means 'throw and catch', creating an exciting display of trust and coordination.",
      mainImage: "/aso-main.png",
      images: [
        "/aso-1.png",
        "/aso-2.png",
        "/aso-3.png"
    ...
    },
    {
      ...
      description: "Also known as Sansankrɔma, this stone-passing game requires players to coordinate their movements with the rhythm of the song while passing and grabbing stones.",
      mainImage: "/bankye-main.png",
      images: [
        "/bankye-1.png",
        "/bankye-2.png",
        "/bankye-3.png"
    ...
    {
      title: "Ampe",
      description: "A high-energy jumping game where players face each other, jump, clap, and use strategic foot movements to score points. Terms like 'Ohyiwa' and 'Opare' determine winning moves.",
      mainImage: "/ampe-main.png",
      images: [
        "/ampe-1.png",
        "/ampe-2.png",
        "/ampe-3.png"
    ...
    {
      title: "Karikokoo",
      description: "Originally a strength-testing game used to select cocoa bean loaders, this back-to-back lifting game tests endurance and strength between two competitors.",
